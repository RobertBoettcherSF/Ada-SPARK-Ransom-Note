...
package body ada_main is
   ...
   E103 : Short_Integer; pragma Import (Ada, E103, "ransom_note_E");
...
--  BEGIN Object file/option list
   --   /workspace/.spark-staging/Ada-SPARK-Ransom-Note/obj/ransom_note.o
   --   /workspace/.spark-staging/Ada-SPARK-Ransom-Note/obj/tests.o
   --   -L/workspace/.spark-staging/Ada-SPARK-Ransom-Note/obj/
   --   -L/workspace/.spark-staging/Ada-SPARK-Ransom-Note/obj/
